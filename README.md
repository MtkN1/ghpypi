...
ghpypi reads Python distribution assets from a GitHub Release, records them in an OCI catalog stored in GHCR, and generates a static [Simple Repository API][simple-api] for publication with GitHub Pages.
